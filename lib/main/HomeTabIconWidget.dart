...
import 'package:flutter_hexindai/common/constant/Colors.dart';
...
class HomeTabIconWidget extends StatelessWidget {
  /// Creates an icon.
  ///
  /// The [size] and [color] default to the value given by the current [IconTheme].
  const HomeTabIconWidget(
    this.selectedImage,
    this.normalImage, {
    Key key,
    this.size,
  ...
  ///
  /// This property has no effect if the [selectedImage]'s [IconData.matchTextDirection]
  ...
  Widget build(BuildContext context) {
    ...
    return new SizedBox(
      ...
      child: new Center(
        child:
            new Image.asset(iconColor == theme ? selectedImage : normalImage),
      ),
    );
  }
}
